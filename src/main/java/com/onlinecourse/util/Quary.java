...
public class Quary {
	...
	public static String verifyUserDetailsQuary="select * from login where userrId=? and userpassword=?";
	...
	public static String addCourseQuary="insert into course value(?,?,?,?,?)";
